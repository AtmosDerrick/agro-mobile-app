...
const SocialMedia = ({ navigation }) => {
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      navigation.navigate("reply", {
                        ...
                        firstname: item.profileFirstName,
  ...
  return (
    <KeyboardAvoidingView
      className="mx-auto w-full flex-1 mb-24"
      behavior={"height"}>
      <FlatList
        data={tweets}
      ...
      />
      <TouchableOpacity
        className="  flex-row justify-center items-center mt-2  rounded-full py-4 px-4 shadow-lg mr-4 bg-green-600 absolute bottom-32 right-3"
        onPress={() => {
